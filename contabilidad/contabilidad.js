...
async function createPedidoContabilidadCard(pedido, isPagado = false) {
    ...
    const documentoPagoContent = `
        ${tienePago ? `<a href="${dataURLToBlobURL(pedido.transferenciaPDF)}" target="_blank" rel="noopener" class="doc-link">📄 Ver pago</a>` : '<span class="doc-placeholder">Sin documento</span>'}
        ${puedeGestionarPago ? (
            tienePago
...
async function createPedidoEspecialContabilidadCard(pedido) {
    ...
    const documentoPagoContent = tieneDocumentoPago
        ? `<a href="${dataURLToBlobURL(pedido.documentoPago)}" target="_blank" rel="noopener" class="doc-link">📄 Ver documento de pago</a>`
        : '<span class="doc-placeholder">Sin documento</span>';
